...
export class CustomAttributesApi extends BaseAPI {
     ...
     */
    deleteAttributeContentForResource({ resourceName, objectUuid, attributeUuid }: DeleteAttributeContentForResourceRequest): Observable<Array<ResponseAttribute>>
    deleteAttributeContentForResource({ resourceName, objectUuid, attributeUuid }: DeleteAttributeContentForResourceRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<ResponseAttribute>>>
    deleteAttributeContentForResource({ resourceName, objectUuid, attributeUuid }: DeleteAttributeContentForResourceRequest, opts?: OperationOpts): Observable<Array<ResponseAttribute> | AjaxResponse<Array<ResponseAttribute>>> {
     ...
     */
    updateAttributeContentForResource({ resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest): Observable<Array<ResponseAttribute>>
    updateAttributeContentForResource({ resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<ResponseAttribute>>>
    updateAttributeContentForResource({ resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest, opts?: OperationOpts): Observable<Array<ResponseAttribute> | AjaxResponse<Array<ResponseAttribute>>> {
